...
class WJ001 extends AbstractEnumeration
{
    ...
    const code = [
        ...
        '1110' => "Waarde gemeentecode moet gelijk zijn aan value gemeentecode voorlooprecord.",
        ...
        '8215' => "Waarde Berekend bedrag is ongelijk aan value Aantal uitgevoerde producten maal Tarief product (incl. BTW).",
